...
sites_fetched = [
  ...
  {:url=>"https://www.wedressfair.fr/", :statistics=>{"url"=>"https://www.wedressfair.fr/", "green"=>true, "bytes"=>6292023, "cleanerThan"=>0.18, "statistics"=>{"adjustedBytes"=>4750477.365, "energy"=>0.0035836237162817273, "co2"=>{"grid"=>{"grams"=>1.5839616825965235, "litres"=>0.8809994878601862}, "renewable"=>{"grams"=>1.373244608079158, "litres"=>0.7637986510136275}}}, "timestamp"=>1670492718}},
  {:url=>"https://wwws.airfrance.fr/", :statistics=>{"url"=>"https://wwws.airfrance.fr/", "green"=>true, "bytes"=>2524315, "cleanerThan"=>0.45, "statistics"=>{"adjustedBytes"=>1905857.825, "energy"=>0.0014377244173083455, "co2"=>{"grid"=>{"grams"=>0.6354741924502887, "litres"=>0.3534507458408505}, "renewable"=>{"grams"=>0.5509359967125581, "litres"=>0.3064306013715248}}}, "timestamp"=>1670430025}},
